...
```sh
docker run --rm -v $PWD:/tmp ghcr.io/degauss-org/st_census_tract:0.2.3 my_address_file_geocoded.csv
```

will produce `my_address_file_geocoded_st_census_tract_0.2.3.csv` with added columns:
